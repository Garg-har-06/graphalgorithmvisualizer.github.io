var tutorial_text = [
	"1)Click on the 'T' button to bring out the tools to draw graph." + "\n" +"\
	 ...
	 3)We will learn about adding node in next slide, so click on 'T' and open the tools pannel.",
	...
	"1)To add a node with CUSTOM NAME you can choose the custom name option in 'NODE ENUM'"+"\n" +"\
	 ...
	 3)Now we will learn about deleting the Node you have added.",
	...
	"1)Focus on one of the node(ignore this step if already focused)"+"\n" +"\
	 ...
	 4)To remove the foccus of the current node click on the focused node itself",
